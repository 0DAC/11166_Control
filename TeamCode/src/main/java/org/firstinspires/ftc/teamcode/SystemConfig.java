...
public class SystemConfig {
    ...
    public String[] top_left  = new String[] {"top_left"};
    public String[] top_right = new String[] {"top_right"};
    public String[] bot_left  = new String[] {"bot_left"};
    public String[] bot_right = new String[] {"bot_right"};
