package org.firstinspires.ftc.teamcode.HOMAR.internal.activator;
...
/**
 * Use this if you have a motor that you normally only turn on and off (e.g. part of an out_intake mechanism).
